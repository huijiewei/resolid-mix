...
import { forwardRef, useCallback, useMemo, useRef, useState, type MouseEvent, type TouchEvent } from 'react';
...
export const Slider = forwardRef<HTMLInputElement, Props<'div', SliderProps>>((props, ref) => {
  const {
    className,
    children,
    color = 'primary',
