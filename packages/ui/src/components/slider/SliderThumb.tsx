...
const SliderThumbButton = forwardRef<
  HTMLButtonElement,
  Props<'button', SliderThumbButtonProps, 'role' | 'type' | 'tabIndex'>
>((props, ref) => {
  ...
  return (
    <Tooltip.Root opened={focus || hover || dragging} placement={vertical ? 'right' : 'top'}>
...
export const SliderThumb = forwardRef<
  HTMLButtonElement,
  Props<'button', SliderThumbChild, 'value' | 'color' | 'type' | 'role' | 'tabIndex'>
>((props, ref) => {
